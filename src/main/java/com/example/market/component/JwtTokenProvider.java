...
import static com.example.market.type.Constants.AUTH;
import static com.example.market.type.Constants.SEPARATOR;
...
public class JwtTokenProvider {
    ...
    public TokenDto generateToken(Authentication authentication) {
        ...
        // TODO: Date 는 사용하지 마시고 LocalDate / LocalDateTime /Instant => java 8 이후로 나온 LocalDate
    ...
    public Authentication getAuthentication(String accessToken) {
        ...
        Collection<? extends GrantedAuthority> authorities =
                Arrays.stream(claims.get(AUTH).toString().split(SEPARATOR))
